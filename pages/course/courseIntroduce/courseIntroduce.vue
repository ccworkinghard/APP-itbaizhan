	...
	<view class="home">
		<view class="courseIntroduce_box">
			<view class="courseIntroduce_des">
				<view class="courseIntroduce_info">
					{{introduce}}
				</view>
			</view>
			<CourseIntroduceData :msg="introduceList"></CourseIntroduceData>
			...
			<view class="courseIntroduce_tab_box">
				...
				<view class="courseIntroduce_tab_con">
					<view class="discount_info" :class="{dis:count === 0}">
						<CourseList :videoList="Clist"></CourseList>
					</view>
					<view class="discount_info" :class="{dis:count === 1}">
						<CourseJieshao :images="imageT" :imageHeight="imageHeight"></CourseJieshao>
					</view>
				</view>
			</view>
...
<script>
	import CourseIntroduceData from "../../../uni_modules/courseIntroduce-data/courseIntroduce-data.vue"
	import CourseList from "../../../uni_modules/courseList/courseList.vue"
	import CourseJieshao from "../../../uni_modules/course-jieshao/course-jieshao.vue"
	export default {
		data() {
			return {
				introduce:"",
		...
		onLoad(options) {
			console.log(options)
			uni.request({
				url:"http://html5.bjsxt.cn/api/course/detail?id=4&course=no",
				data:{
					id: options.id,
				...
				success: (res) => {
					...
					this.introduce = res.data.data.introduceList//原API中的introduce数据发生改变，改为读取课程简介列表
